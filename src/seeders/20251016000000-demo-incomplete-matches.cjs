...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('matches', [
      // Partido con solo 1 jugador (el creador)
      {
        ...
        player4Id: null,
        status: 'scheduled',
        notes: 'Partido abierto - buscando 3 jugadores más para completar el equipo',
        createdAt: new Date(),
        updatedAt: new Date()
      },
      ...
      // Partido con solo 1 jugador (el creador) - en progreso
      {
